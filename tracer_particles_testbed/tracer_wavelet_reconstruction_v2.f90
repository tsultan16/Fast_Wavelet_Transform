...
INTEGER, PARAMETER :: dump_num = 3
INTEGER, PARAMETER :: nx = 20, ny = 20, nz = 20, nb = 6
INTEGER, PARAMETER :: nranks_x = 2, nranks_y = 2, nranks_z = 2
    ...
    DO k = 0, nranks_z-1
        DO j = 0, nranks_y-1
            DO i = 0, nranks_x-1
                ...
                ALLOCATE(dat_rec(i,j,k)%patch_array(1-nb:nx+nb,1-nb:ny+nb,1-nb:nz+nb,1:nscalars))
